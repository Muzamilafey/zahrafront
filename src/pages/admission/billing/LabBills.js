  ...
  if (loading) {
    return (
      <div className="p-6">
        ...
        <div className="text-gray-500">Loading lab bills...</div>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold text-gray-800">Lab Bills</h1>
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        {invoices.length === 0 ? (
          <div className="p-6 text-center text-gray-500">
            No lab bills found for this patient
          </div>
        ) : (
              ...
              <tbody>
                {invoices.map((inv) => (
                  <tr key={inv._id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="px-6 py-3 text-sm">{inv.description || inv.type || 'Lab Bill'}</td>
